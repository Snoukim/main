...
bot = telebot.TeleBot('6435094608:AAEwdzHIDBZ5X6PWCH7Pmawen-J6DuB9vPQ')
...
def callback(call):
    if call.data != 'else':
        ...
        bot.send_message(call.message.chat.id, f'Получаеться: {round(res, 2)}. Можете заново вписать сумму')
